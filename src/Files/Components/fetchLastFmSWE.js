...
export default function FetchLastFmSweden () {
    ...
    const fetchUrl = async () => {
        ...
        try { 
            ...
            const response = await fetch('http://ws.audioscrobbler.com/2.0/?method=geo.gettoptracks&country=sweden&limit=10&api_key=ab29089f40be1f28c5b34468b4afb05f&format=json');
